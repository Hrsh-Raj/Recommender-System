...
class AppConfiguration:
    def __init__(self, config_file_path:str = CONFIG_FILE_PATH):
        try:
            self.configs_info = read_yaml_file(file_path=config_file_path) #Read the config.yaml file, and converts into dictionary
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            logging.info(f'Data_Ingestion_Config: {response}')
            return response
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            data_ingestion_config = self.configs_info['data_ingestion_config']
            dataset_dir = data_ingestion_config['dataset_dir']
            artifcats_dir = self.configs_info['artifacts_config']['artifacts_dir']



            transformed_data_file_dir = os.path.join(artifcats_dir, dataset_dir, data_transformation_config['transformed_data_dir'], 'transformed_data.pkl')
            trained_model_dir = os.path.join(artifcats_dir, model_trainer_config['trained_model_dir'])
